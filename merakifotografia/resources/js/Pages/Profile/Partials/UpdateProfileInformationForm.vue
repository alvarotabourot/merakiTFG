...
const form = useForm({
    ...
    email: user.email,
    foto: user.foto,
    currentImage: user.foto ? `/imagenes/fotosUsuarios/${user.foto}` : `/imagenes/fotosUsuarios/defaultProfile.jpg`,
...
<template>
    <section class="bg-white p-6 rounded-lg text-white">
        ...
        <form @submit.prevent="handleSubmit" class="mt-6 space-y-6">
            <div class="mb-4" v-if="user.rol_id === 2">
                <div>
                    ...
                    <div class="flex flex-col items-center justify-center w-full relative">
                        ...
                        <label
                            for="foto"
                            class="flex flex-col items-center justify-center w-32 h-32 border-2 border-purple-400 border-dashed rounded-full cursor-pointer bg-gray-700 hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 relative">
                                <div v-if="form.currentImage" class="absolute w-32 h-32 flex items-center justify-center bg-black border-2 border-purple-400 border-dashed rounded-full cursor-pointer overflow-hidden">
            ...
            <div>
                ...
                <TextInput
                    id="nombre"
                    type="text"
                    class="mt-1 block w-full px-2 text-black border-2 border-purple-400"
                    v-model="form.nombre"
                    autofocus
                    autocomplete="nombre"
                />
            ...
            <div v-if="user.rol_id === 2">
                <InputLabel for="descripcion" value="Descripción" class="text-gray-800"/>
                <TextInput
                    id="descripcion"
                    type="text"
                    class="mt-1 block w-full px-2 text-black border-2 border-purple-400"
            ...
            <!-- Usuario -->
            <div>
                <InputLabel for="usuario" value="Usuario" class="text-gray-800"/>
                <TextInput
                    id="usuario"
                    type="text"
                    class="mt-1 block w-full px-2 text-black border-2 border-purple-400"
